...
import { ChevronLeft, Info, HelpCircle, AlertCircle, PlayCircle, CheckCircle } from 'lucide-react';
      ...
      <div className="container" style={{ padding: '1.5rem', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ marginTop: 'auto', paddingBottom: '3rem' }}>
          {quiz.is_submitted ? (
            <button 
              className="btn-elite" 
              style={{ width: '100%', height: '72px', fontSize: '1.25rem', background: '#10b981', color: 'white', border: 'none' }}
              onClick={() => navigate(`/study-result/${id}`)}
            >
