    ...
    <div className="mesh-bg-blue" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'white' }}>
      <div className="container" style={{ padding: 'var(--page-padding)' }}>
        <div className="auth-split">
          ...
          {/* Header content */}
          <div style={{ marginBottom: '3rem', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }} className="animate-elite auth-brand">
            <img 
              src={logo} 
              alt="Play11 Logo" 
              style={{ 
            ...
            />
            <h2 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 900, fontFamily: 'Lexend', marginBottom: '0.75rem', color: 'hsl(var(--foreground))' }}>Secure Entry</h2>
            <p style={{ color: 'hsl(var(--muted-foreground))', fontWeight: 600, fontSize: 'clamp(0.95rem, 2vw, 1.2rem)' }}>
